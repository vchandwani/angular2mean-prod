...
var PortfolioComponent = /** @class */ (function () {
    function PortfolioComponent(spinnerService, portfolioService, errorService) {
        ...
        this.colors = ['#ffff00', '#ff6600', '#ff0066', '#ff66ff', '#6699ff', '#33ccff', '#66ffcc', '#66ff66', '#ccff66', '#0000ff', '#009933', '#ff0000', '#6600cc', '#ccffcc', '#800080', '#00cccc', '#99e600', '#e65c00', '#4080bf'];
                ...
                _this.portfolioService.getLastEntry()
                    ...
                    data.forEach(function (item) {
                        if (item.type = 'MF' && _this.activeFunds.indexOf(item._id) > -1) {
                            ...
                            _this.mutualChartColors[0].backgroundColor.push(_this.colors[Math.floor(Math.random() * _this.colors.length)]);
                            z++;
                        }
                            ...
                            _this.stockChartColors[0].backgroundColor.push(_this.colors[Math.floor(Math.random() * _this.colors.length)]);
                            k++;
                        }
                    });
            ...
            setTimeout(function () {
                ...
                _this.portfolioService.zeroEntries()
                    ...
                    if (typeof data != 'undefined' && data) {
                        ...
                        if (i == 2) {
                            _this.spinnerService.hide();
                            _this.errorService.handleSuccess({ title: 'Process Completed', success: true }, 201);
                        }
                    }
                }, function (error) {
                    _this.spinnerService.hide();
